  ...
  <div class="content-text">
    ...
    <div class="formRight" v-show="formShow">
      <el-form :model="questionNewMes" ref="questionNewMes" label-width="80px" class="demo-dynamic">
        ...
        <el-form-item prop="typeCode" label="试题题型:">
        ...
        <el-form-item>
          <!--<router-link :to="{path:'/statmaincons/addstatic',query: {sequenceNbr:staticNewMes.sequenceNbr}}">-->
...
<script>
  ...
  import { URL_GET, URL_POST, URL_PUT, TIKA_SYSTEM,TIKA_VIP } from 'api/config'
  export default {
    data() {
      return {
        subjectCode: '',
    ...
    methods: {
      ...
      _getMesLists() {//获取vip试题 分页信息列表

        let url = "/v1/viptiku/QuestionInfoVip/bigAndSmallPage/question?agencyCode="+sessionStorage.getItem("agencyCode") + '&subjectCode=' + this.subjectCode
          +'&current=' + this.current+ "&size=" + this.size  + "&typeCode=" + this.typeCode
